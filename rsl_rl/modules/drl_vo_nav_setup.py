...
class CustomCNN(nn.Module):
    ...
    def __init__(self, features_dim:int = 256):
        ...
        #
        # TODO: @vairaviv commented it out as imo not needed as everything defined here
...
class ActorCriticDRLVONav(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        num_critic_obs = 256,
        num_actions = 2,
        actor_hidden_dims=[256, 2],
        critic_hidden_dims=[128, 1],
        activation="relu",
        init_noise_std=1.0,
        **kwargs,
    ):
        ...
        self.actor_nn = nn.Sequential(*actor_layers)
        self.actor = nn.Sequential(self.feature_extractor, self.actor_nn)
        ...
        self.critic_nn = nn.Sequential(*critic_layers)
        self.critic = nn.Sequential(self.feature_extractor, self.critic_nn)
    ...
    def actor_forward(self, observations):
        ...
        return self.actor_nn(features)
    
    def critic_forward(self, observations):
        features = self.feature_extractor(observations)
        return self.critic_nn(features)
